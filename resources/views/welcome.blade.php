...
<body class="font-sans antialiased dark:bg-black dark:text-white/50 p-6">
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6 flex justify-center items-center ">
                    <div class=" justify-center items-center w-1/2">
                        <a href="https://laravel.com/docs" id="docs-card" class="flex flex-col items-start overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20]  dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                            <div id="screenshot-container" class="relative flex w-1/2 flex-1 items-stretch">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-2xl font-semibold text-black dark:text-white">B I E N V E N I D O</h2>
                                    </div>
                                </div>
                            </div>
                        </a>
